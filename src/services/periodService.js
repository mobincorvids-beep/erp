...
function listAccountingPeriods(companyId) {
  return AccountingPeriod.find({ companyId }).sort({ startDate: 1 });
}
...
module.exports = { createFiscalYear, createAccountingPeriod, listAccountingPeriods, closePeriod, reopenPeriod, assertPeriodOpen };
